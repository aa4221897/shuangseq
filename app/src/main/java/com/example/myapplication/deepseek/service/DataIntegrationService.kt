...
import com.example.myapplication.deepseek.knowledge.KnowledgeUpdater
...
class DataIntegrationService(
    ...
    suspend fun integrateDataWithDeepSeek() {
        // 1. 更新知识库数据
        knowledgeUpdater.refreshKnowledgeBase()
        ...
        val report = """
            ...
            最后更新: ${KnowledgeBase.get("last_update")}
        ...
        // 3. 存入知识库
        KnowledgeBase.update("data_report", report)
    }
}